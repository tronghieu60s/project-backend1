...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 05, 2021 lúc 08:13 AM
...
(10, 'admin@gmail.com', 'admin', 'ok bạn', 5, 20, '2021-01-05 05:55:13'),
(11, 'nhom6@gmail.com', 'nhom6', 'sp tot', 5, 22, '2021-01-05 07:11:36'),
(12, 'nhom6@gmail.com', 'nhom6', 'spam', 5, 22, '2021-01-05 07:11:53');
...
(17, 'Máy tính bảng Huawei MediaPad T3 10 (2017)', 9, 6, 3740000, 'huawei-mediapad-t3-10-1-33397-chitiet-400x460.png', '                                                Huawei MediaPad T3 10 (2017) là chiếc máy tính bảng với màn hình kích thước lớn cùng khe cắm sim tiện lợi giúp người dùng có thể nghe gọi như một chiếc smartphone.\r\nThiết kế mỏng, đẹp\r\nVề tổng thể, máy nổi bật với phần khung viền kim loại sang trọng, kết hợp màu sắc hiện đại cho cảm giác khá thanh lịch, nhẹ nhàng.                                            ', 1, '2020-11-17 08:55:26'),
...
(6, 'admin', '$2y$10$dwBoo0WOqyuTJKUbZrLuwOcn/yQJyVHCC.9z.bV/SNuJfjQXRg1gS', 9),
(17, 'user', '$2y$10$QVUeLR2UTqG2dqtKwQ/y3.uDFy8yRBq/9hwBWoxcB43D2321We17K', 1),
(19, 'nhom6', '$2y$10$5X32t7JGSDlXDC/cVAxQLeMuW3WFS8qMOJ1F8wvq5jxkfx79JhE0a', 1);
